...
It's important to note that if you sync your shared folder to /home/vagrant you'll not ssh into your box as this
clears your home directory which will have the .ssh
